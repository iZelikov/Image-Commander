...
- Запустить скрипт *init.sh* командой `chmod +x init.sh
./init.sh`
...
При желании можно создать резервную копию BD запуском скрипта *backup.sh* в корне проекта. Команда для запуска `chmod +x init.sh
./backup.sh`
