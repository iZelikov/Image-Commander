...
- Переименовать файл .env-example в .env и заполнить его своими учётными данными для BD
...
- Доступ по https:// пока не предусмотрен (в старые Dos'овские времена никаких богомерзких https'ов не было)
...
- my_site/api/delete/<filename> - удаляет картинку с переданным именем (и не спрашивает никаких подтверждений!)
...
Максимальный размер одного запроса (сумма размеров всех файлов) - 50 МБ. Может быть я когда-нибудь сподоблюсь и научу эту шайтан-машину разбивать большой запрос на подзапросы.
...
Командой shell можно перевести приложение в режим условно-графической облочки. В которой уже можно кликать мышкой, скролить колёсиком, выбирать стрелками, закидывать файлы драг-эн-дропом и использовать горячие клавиши.
...
- Не стесняйтесь нажимать в браузере Ctrl+F5, на случай если у вас закэшировался старый CSS или JS
- Сайт не оптимизирован для просмотра с мобильных устройств. Открывайте на телефоне на свой страх и риск. 
