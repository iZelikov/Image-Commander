...
- `my_site/api/get_images/` - возвращает JSON со списком всех загруженных картинок. Ключи JSON: {'id', 'filename', 'original_filename', 'size', 'upload_time', 'file_type', 'link', 'preview'}.
